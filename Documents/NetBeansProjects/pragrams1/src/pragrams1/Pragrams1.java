...
public class Pragrams1 {
    ...
    public static void main(String[] args) {
        ...
        if (total <= loadCapacity) {
            System.out.println("The available weight capacity of the truck is =" + (loadCapacity - total) + mass);
        } else 
            if (total > loadCapacity) {
            System.out.println("The truck is completely overloaded!!");
            System.out.println("Release at least" + " " + (total - loadCapacity) + mass + " " + "in order for you to drive well.");
